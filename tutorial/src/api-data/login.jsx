                ...
                <div className="container my-5">
                    ...
                    <form>
                        <div className="form-group">
                            ...
                            <input ref={this.password} type="email" className="form-control" id="exampleInputEmail1"
                        ...
                        <div className="form-group">
                            ...
                            <input ref={this.email} type="password" className="form-control" id="exampleInputPassword1"
